              ...
              <tbody className="divide-y divide-gray-100">
                {visibleTrackers.map(tracker => (
                  <tr key={tracker.id} className="align-top hover:bg-gray-50">
                    ...
                    <td className="whitespace-nowrap px-4 py-3 text-gray-600"><Calendar className="mr-1 inline h-4 w-4" />{tracker.results?.[0] ? new Date(tracker.results[0].created_at).toLocaleDateString('en-US', { month: 'short', day: 'numeric' }) : 'Never checked'}</td>
